...
## Project Structure
    ...
    ├── testapiautoteammemb_89288  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_89288`
...
2. Clone this repo and `cd testapiautoteammemb_89288`
